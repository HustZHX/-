...
import gc
# 训练集
train_images_idx3_ubyte_file = 'C:\\Users\\10094\\Downloads\\mnist_dataset\\train-images.idx3-ubyte'
# 训练集标签
train_labels_idx1_ubyte_file = 'C:\\Users\\10094\\Downloads\\mnist_dataset\\train-labels.idx1-ubyte'
# 测试集
test_images_idx3_ubyte_file = 'C:\\Users\\10094\\Downloads\\mnist_dataset\\t10k-images.idx3-ubyte'
# 测试集标签
test_labels_idx1_ubyte_file = 'C:\\Users\\10094\\Downloads\\mnist_dataset\\t10k-labels.idx1-ubyte'
...
if __name__ == '__main__':
    ...
    for i in range(mTest):
        ...
        print("%d:识别结果：%d 正确答案：%d" % (z,Result, classNumStr))
        z=z+1
